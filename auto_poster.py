...
def generate_post(campaign, keyword):
    ...
    profile_prompt = f"당신은 30~50대를 위한 전문 'CEO 및 비즈니스 리더를 위한 프리미엄 골프 & 라이프스타일 큐레이터'입니다. 주요 전문 분야: 'VIP 1:1 맞춤 스윙 교정, 비즈니스 골프 매너, 단기 필드 타수 개선과 스케줄 유연성'. '{keyword}'의 타겟 유저가 가장 갈망하는 혜택과 현실적 고민이 무엇인지 전문가의 시각에서 3문장으로 날카롭게 분석하세요."
